// dsh-mattpocock-skills-plugin — DeepSeek Harness 插件
//
...
export const name = 'dsh-mattpocock-skills-plugin'
...
export function apply(ctx) {
  ...
  if (!ctx.skills || typeof ctx.skills.register !== 'function') {
    ctx.logger?.warn?.('dsh-mattpocock-skills-plugin: ctx.skills 服务不可用,插件未注册任何技能')
    return
  }
  const disposers = []
